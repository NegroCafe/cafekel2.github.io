...
<div class="col-lg-9 mt-2">
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            <h5 class="card-title">NEGROCAFE - APLIKASI PEMESANAN MAKANAN DAN MINUMAN CAFE</h5>
            <p class="card-text">Aplikasi pemesanan makanan dan minuman yang mudah dan praktis. Nikmati beragam makanan dan minuman favorit Anda dengan beberapa klik. Pesan, Bayar, dan Lacak Pesanan Anda dengan mudah melalui aplikasi ini.</p>
